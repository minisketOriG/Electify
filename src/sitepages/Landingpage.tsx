...
const Landingpage = () => {
  ...
  return (
    <>
      ...
      <main>
        <div className="flex items-center justify-center flex-col w-full h-[500px] bg-[url('/src/assets/images/heroImg.png')] bg-cover bg-center">
          ...
          <img src="/src/assets/images/electifyLogoBlack.png" alt="heroImg" className="w-[120px] h-[70px] my-10" />
        ...
        <div id="hero_section_47d9a" className="w-full h-[500px] bg-gradient-to-r from-[#040405] to-[#5D5959]">
          <div className="flex items-center justify-around w-full h-full">
            ...
            <section>
              <img src="/src/assets/images/ballotImg.png" alt="ballotImg" className="w-[250px] h-[300px]" />
            </section>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center justify-center bg-gradient-to-r from-[#040405] to-[#5D5959]">
          ...
          <img className="w-[600px] h-[400px] " src="src/assets/images/cardImg.png" alt="Credit Card " />
        ...
        <div className="w-full flex flex-col items-center justify-center py-8 bg-[url('src/assets/images/heroImg.png')] bg-cover bg-center">
