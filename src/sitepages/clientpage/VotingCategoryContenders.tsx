...
const VotingCategoryContenders = () => {
  ...
  const contenderDetails = [
    { name: "Paul Kaume", age: 26, occupation: "Care taker", votes: 340, percentage: "28%", image: "/src/assets/images/contendImg.jpg" },
    { name: "Adu Osei Bonsu", age: 26, occupation: "Care taker", votes: 340, percentage: "28%", image: "/src/assets/images/contendImg1.jpg" },
    { name: "Jane Doe", age: 30, occupation: "Software Engineer", votes: 420, percentage: "35%", image: "/src/assets/images/contendImg2.jpg" },
    { name: "John Smith", age: 29, occupation: "Graphic Designer", votes: 280, percentage: "23%", image: "/src/assets/images/contendImg3.jpg" },
    { name: "Emily Johnson", age: 24, occupation: "Marketing Specialist", votes: 310, percentage: "26%", image: "/src/assets/images/contendImg.jpg" },
    { name: "Michael Brown", age: 32, occupation: "Photographer", votes: 390, percentage: "33%", image: "/src/assets/images/contendImg2.jpg" },
  ];
