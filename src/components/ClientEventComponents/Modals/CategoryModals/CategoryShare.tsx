...
import { setShowShare } from "@/store/DataSlides/CategoryPageStatesSlide"
import { useRef, useState } from "react"
import { FaFacebook, FaXTwitter, FaInstagram, FaWhatsapp, FaSpinner, FaCircleCheck, FaCopy } from "react-icons/fa6"
            ...
            <div className="absolute top-0 bottom-0 left-0 right-0 z-50 bg-black/50 flex justify-center items-center">
                <div className="relative w-[500px] max-h-[90%] overflow-auto flex justify-center items-center flex-col p-4 bg-white rounded-[10px]">
                    ...
                    <div className="flex justify-center items-center mt-5">
                        <span className="font-poppins font-medium">Share this category with your potential voters!</span>
                    </div>
                    ...
                    <div className="w-full flex justify-center items-center space-x-5 p-3 bg-gray-200 mt-5 mb-2 rounded-[10px] border-2 border-gray-400">
                        <span ref={linkRef} className="w-[90%] font-poppins text-[14px] font-semibold text-center text-nowrap text-ellipsis overflow-hidden">https://example.com/bd2yu237dsda9d/2893e2893xsxax</span>
