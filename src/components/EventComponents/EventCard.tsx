        ...
        <>
            <div className="w-5/6 flex justify-around items-center flex-row px-2 py-5 border-2 border-[#0C35BC] rounded-[10px] shadow-[0px_0px_5px_#0C35BC]">
                ...
                <div className="flex justify-center items-center flex-row space-x-2">
                    ...
                    <button onClick={showShareEvent} className="w-[35px] h-[35px] bg-[#0C35BC] flex justify-center items-center text-white text-xl p-1 rounded-[10px] border-2 border-[#0C35BC] 
                    ...
                    <Link to="/clientpage/eventcategory/6009831">
                        <button className="bg-[#0C35BC] flex justify-center items-center text-white text-xl px-4 py-2 rounded-[5px] border-2 border-[#0C35BC] 
